...
function start(options,func){
    ...
    let _isDoc =  serverConf.documentation;
    ...
    Config.registrations.forEach(function(item) {
        ...
        if(!serverConf.documentation && _temp ==="hapi-swagger"){
           console.log(`documentation ${serverConf.documentation}` );
        }else{
